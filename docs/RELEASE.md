...
```bash
bash scripts/release/package-macos.sh 0.1.5
```
...
README into `Codex-Halo-macOS-Universal-v0.1.5.zip`. It does not hand-assemble an
incomplete `.app`.

From Windows PowerShell:

```powershell
./scripts/release/package-windows.ps1 0.1.5
```

Output: `Codex-Halo-Windows-x64-v0.1.5.zip`.
